...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description_seo" class="form-control" placeholder="description_seo"
                                   value="<?php echo e($obj->description_seo); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="keyword_seo" class="form-control" placeholder="keyword_seo"
                                   value="<?php echo e($obj->keyword_seo); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title_seo" class="form-control" placeholder="title_seo"
                                   value="<?php echo e($obj->title_seo); ?>">
...
<?php echo $__env->make('be.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\workplace\shopee_backend_cp17\resources\views/be/product/edit.blade.php ENDPATH**/ ?>