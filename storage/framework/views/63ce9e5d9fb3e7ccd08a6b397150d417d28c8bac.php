<?php $__env->startSection('main-content'); ?>
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- form start -->
            <form method="post" action="<?php echo e(route('admin.discount.doEdit',['id'=>$obj->id])); ?>"
...
unset($__errorArgs, $__bag); ?> </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="" placeholder="discount percent"
                               ...
                               value="<?php echo e($obj->discount_percent); ?>" step="any">
...
<?php echo $__env->make('be.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\workplace\shopee_backend_cp17\resources\views/be/discount/edit.blade.php ENDPATH**/ ?>