                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning"
                                       href="<?php echo e(route('admin.user_address.edit',['id'=>$item->id])); ?>">Edit</a>
                                    <a class="btn btn-danger" onclick="return confirm('Bạn có muốn xoá ?')"
                                       href="<?php echo e(route('admin.user_address.delete',['id'=>$item->id])); ?>">Delete</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('be.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\workplace\shopee_backend_cp17\resources\views/be/user_address/list.blade.php ENDPATH**/ ?>