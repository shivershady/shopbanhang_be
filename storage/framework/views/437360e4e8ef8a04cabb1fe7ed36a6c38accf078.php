                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning"
                                           href="<?php echo e(route('admin.user.edit',['id'=>$item->id])); ?>">Sửa</a>
                                        <a class="btn btn-danger" onclick="return confirm('Bạn có muốn xoá ?')"
                                           href="<?php echo e(route('admin.user.delete',['id'=>$item->id])); ?>">Xoá</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('be.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lrandom/Desktop/laravel/shopbanhang_be/resources/views/be/user/list.blade.php ENDPATH**/ ?>